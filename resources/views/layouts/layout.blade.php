...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="container collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex" action="{{ route('post.index') }}">
                <input class="form-control my-sm-2" name="search" type="search" placeholder="Найти пост..." aria-label="Search">
                <button class="btn btn-outline-success ms-2 my-sm-2" type="submit">Поиск</button>
            </form>
